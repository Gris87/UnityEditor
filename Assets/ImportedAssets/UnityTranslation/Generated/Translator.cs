...
namespace UnityTranslation
{
    ...
    public static class Translator
    {
        ...
        public static string getString(R.sections.AboutDialog.strings id)
        {
            ...
            if (
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage != null
                &&
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage.stringValues[(int)id] != null
               )
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage.stringValues[(int)id];
            }
            else
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].defaultLanguage.stringValues[(int)id];
            }
        }
        ...
        public static string[] getStringArray(R.sections.AboutDialog.array id)
        {
            ...
            if (
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage != null
                &&
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage.stringArrayValues[(int)id] != null
               )
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage.stringArrayValues[(int)id];
            }
            else
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].defaultLanguage.stringArrayValues[(int)id];
            }
        }
        ...
        public static string getQuantityString(R.sections.AboutDialog.plurals id, double quantity)
        {
            ...
            if (
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage != null
                &&
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage.pluralsValues[(int)id] != null
               )
            {
                pluralsValues   = UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].selectedLanguage.pluralsValues[(int)id];
                pluralsQuantity = UnityTranslationInternal.PluralsRules.pluralsFunctions[(int)UnityTranslationInternal.Translator.language](quantity);
            }
            else
            {
                pluralsValues   = UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.AboutDialog + 1].defaultLanguage.pluralsValues[(int)id];
                pluralsQuantity = UnityTranslationInternal.PluralsRules.pluralsFunctions[0](quantity);
            }
        ...
        public static string getString(R.sections.Toolbar.strings id)
        {
            ...
            if (
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage != null
                &&
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage.stringValues[(int)id] != null
               )
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage.stringValues[(int)id];
            }
            else
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].defaultLanguage.stringValues[(int)id];
            }
        }
        ...
        public static string[] getStringArray(R.sections.Toolbar.array id)
        {
            ...
            if (
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage != null
                &&
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage.stringArrayValues[(int)id] != null
               )
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage.stringArrayValues[(int)id];
            }
            else
            {
                return UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].defaultLanguage.stringArrayValues[(int)id];
            }
        }
        ...
        public static string getQuantityString(R.sections.Toolbar.plurals id, double quantity)
        {
            ...
            if (
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage != null
                &&
                UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage.pluralsValues[(int)id] != null
               )
            {
                pluralsValues   = UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].selectedLanguage.pluralsValues[(int)id];
                pluralsQuantity = UnityTranslationInternal.PluralsRules.pluralsFunctions[(int)UnityTranslationInternal.Translator.language](quantity);
            }
            else
            {
                pluralsValues   = UnityTranslationInternal.Translator.tokens[(int)R.sections.SectionID.Toolbar + 1].defaultLanguage.pluralsValues[(int)id];
                pluralsQuantity = UnityTranslationInternal.PluralsRules.pluralsFunctions[0](quantity);
            }
