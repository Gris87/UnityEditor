...
namespace UI.Windows.MainWindow.DockWidgets.Profiler
{
    ...
    public class ProfilerDockWidgetScript : DockWidgetScript
    {
        ...
        {
            DebugEx.VerboseFormat("ProfilerDockWidgetScript.CreateContent(contentTransform = {0})", contentTransform);
        ...
        void OnDestroy()
        {
            ...
            {
                DebugEx.Fatal("Unexpected behaviour in ProfilerDockWidgetScript.OnDestroy()");
            }
        }
    }
}
